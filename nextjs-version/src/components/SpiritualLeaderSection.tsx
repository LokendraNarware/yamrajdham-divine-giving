        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center shadow-lg">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-orange-600 font-medium">🌼 Mataji's Divine Guidance</span>
                </div>
                
                <blockquote className="text-2xl md:text-3xl font-bold text-gray-800 leading-tight italic">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Inspired by Mataji, the Dharam Dham Paavan Nagari Trust was founded with a sacred mission:
                </p>
                
                <ul className="text-lg text-gray-700 leading-relaxed space-y-2 ml-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="border-orange-600 text-orange-600 hover:bg-orange-50 px-8 py-3 rounded-full font-semibold"
                >
                  Join Our Mission
                </Button>
              </div>
