      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="relative flex justify-center">
                <div className="relative">
                  ...
                  <div className="absolute -top-6 -right-6 w-16 h-16 bg-yellow-300 rounded-full flex items-center justify-center shadow-lg">
          ...
          <div className="text-center mt-16">
            <Button 
              size="lg" 
              className="bg-white text-orange-600 hover:bg-gray-100 px-12 py-4 rounded-full font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300"
            >
              Join Our Mission
            </Button>
          </div>
